...
# Add this export variable so we can tell each machine its tier in the editor
...
func _ready():
    ...
    # Connect the draw button's signal to its handler function
...
# New function to handle the draw button press
func _on_draw_button_pressed():
    # Emit a new signal specifically for drawing, and include this machine's tier
