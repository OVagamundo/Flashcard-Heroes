	...
	match hero_id:
		&"hero_timekeeper":
			...
			return [
				...
				# Tier 2
				&"unit_t2_a", &"unit_t2_a", &"unit_t2_b", &"unit_t2_b", &"unit_t2_c", &"unit_t2_c", &"unit_t2_d", &"unit_t2_d", &"unit_t2_e", &"unit_t2_e", &"unit_t2_f", &"unit_t2_g", &"unit_t2_g", &"unit_t2_h", &"unit_t2_h", &"unit_t2_i", &"unit_t2_i",
