...
- [resources/trinkets/trinket_poison_vial.tres](#file-resourcestrinketstrinket_poison_vial.tres)
...
- [scenes/BattleLogOverlay.tscn](#file-scenesBattleLogOverlay.tscn)
...
- [scripts/BattleLogOverlay.gd](#file-scriptsBattleLogOverlay.gd)
...
- [scripts/TestEnvironmentManager.gd](#file-scriptsTestEnvironmentManager.gd)
...
- [scripts/verify_decks_all.gd](#file-scriptsverify_decks_all.gd)
...
resources/compress/mode=1
resources/compress/min_size=2048

[export_presets.export.Web]

include_filter="*.ttf,*.otf,*.woff,*.woff2"

[export_presets.export.Web.override]

resources/compress/mode=0
res://assets/fonts/NotoSansJP-VariableFont_wght.ttf=""
res://assets/fonts/static/NotoSansJP-Black.ttf=""
res://assets/fonts/static/NotoSansJP-Bold.ttf=""
res://assets/fonts/static/NotoSansJP-ExtraBold.ttf=""
res://assets/fonts/static/NotoSansJP-ExtraLight.ttf=""
res://assets/fonts/static/NotoSansJP-Light.ttf=""
res://assets/fonts/static/NotoSansJP-Medium.ttf=""
res://assets/fonts/static/NotoSansJP-Regular.ttf=""
res://assets/fonts/static/NotoSansJP-SemiBold.ttf=""
res://assets/fonts/static/NotoSansJP-Thin.ttf=""

[internationalization]

font_override/use_system_fonts=false

[locale]

locale_filter=PackedStringArray("en", "ja")
...
textures/webp_compression/lossy_quality=0.9
...
id = &"trinket_healing_amulet_heal"
trigger = &"on_turn_start"
...
<a id="file-resourcestrinketstrinket_poison_vial.tres"></a>

## resources/trinkets/trinket_poison_vial.tres

<!-- Original: resources/trinkets/trinket_poison_vial.tres -->

```ini
[gd_resource type="Resource" script_class="TrinketDefinition" load_steps=5 format=3]

[ext_resource type="Script" path="res://scripts/TrinketDefinition.gd" id="1_script"]
[ext_resource type="Texture2D" path="res://assets/sprites/trinkets/trinket_poison.png" id="2_icon"]
[ext_resource type="Script" path="res://scripts/AbilityDefinition.gd" id="3_ability"]

[sub_resource type="Resource" id="Ability_PoisonVial"]
script = ExtResource("3_ability")
trigger = &"on_passive"
description_key = "Your team's damage applies 1 Poison. Poison deals damage at end of turn, then halves."
effects = Array[Resource]([])

[resource]
script = ExtResource("1_script")
id = &"trinket_poison_vial"
name_key = "Poison Vial"
description_key = "Your team's damage applies 1 Poison. Poison deals damage at end of turn, then halves."
icon = ExtResource("2_icon")
category = &"TRINKET"
is_player_exclusive = false
ability_definitions = Array[Resource]([SubResource("Ability_PoisonVial")])
...
```ini
[gd_scene load_steps=6 format=3 uid="uid://c8qj2qj2qj2q"]
...
<a id="file-scenesBattleLogOverlay.tscn"></a>

## scenes/BattleLogOverlay.tscn

<!-- Original: scenes/BattleLogOverlay.tscn -->
...
[node name="LogText" type="RichTextLabel" parent="BackgroundPanel"]
unique_name_in_owner = true
anchors_preset = 15
anchor_right = 1.0
anchor_bottom = 1.0
...
```ini
[gd_scene load_steps=4 format=3 uid="uid://dajq7v7k8jvhg"]
...
[ext_resource type="FontFile" uid="uid://bkrxvpmgv0ru4" path="res://assets/fonts/static/NotoSansJP-Regular.ttf" id="3_font"]
...
[node name="TestModeButton" type="Button" parent="VBoxContainer"]
unique_name_in_owner = true
layout_mode = 2
text = "Test Mode"
...
```ini
[gd_scene load_steps=7 format=3 uid="uid://crndwktdbp0rc"]
...
<a id="file-scriptsBattleLogOverlay.gd"></a>

## scripts/BattleLogOverlay.gd

<!-- Original: scripts/BattleLogOverlay.gd -->
...
<a id="file-scriptsTestEnvironmentManager.gd"></a>

## scripts/TestEnvironmentManager.gd

<!-- Original: scripts/TestEnvironmentManager.gd -->
...
<a id="file-scriptsverify_decks_all.gd"></a>

## scripts/verify_decks_all.gd

<!-- Original: scripts/verify_decks_all.gd -->
