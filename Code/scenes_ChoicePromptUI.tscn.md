...
[node name="VBoxContainer#Label" type="Label" parent="."]
layout_mode = 2
...
[node name="VBoxContainer#HBoxContainer" type="HBoxContainer" parent="."]
layout_mode = 2
size_flags_vertical = 3
alignment = 1

[node name="HBoxContainer#MergeButton" type="Button" parent="."]
layout_mode = 2
size_flags_horizontal = 3
text = "Merge"

[node name="HBoxContainer#SwapButton" type="Button" parent="."]
layout_mode = 2
size_flags_horizontal = 3
text = "Swap"
